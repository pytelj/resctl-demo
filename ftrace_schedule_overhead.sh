...
echo "/sys/kernel/debug/tracing/function_profile_enabled"
echo 0 | sudo tee -a /sys/kernel/debug/tracing/function_profile_enabled
echo "configurating ftrace to instrument schedule()"
echo "/sys/kernel/tracing/set_ftrace_filter"
echo schedule | sudo tee -a /sys/kernel/tracing/set_ftrace_filter
echo "/sys/kernel/tracing/current_tracer"
echo function | sudo tee -a /sys/kernel/tracing/current_tracer
echo "/sys/kernel/tracing/tracing_on"
echo 0 | sudo tee -a /sys/kernel/tracing/tracing_on
echo "/sys/kernel/debug/tracing/function_profile_enabled"
echo 1 | sudo tee -a /sys/kernel/debug/tracing/function_profile_enabled
